<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"CodeFile="pharmacy.aspx.cs" Inherits="Press_Release_pharmacy" %>
 <%@ Page Title="" Language="C#" MasterPageFile="~/Backend/backend.master" AutoEventWireup="true" CodeFile="Add-PressRelease.aspx.cs" Inherits="Backend_Add_PressRelease" %>

<asp:Content ID="Content3"  ContentPlaceHolderID="head" Runat="Server">
pharmacy</asp:Content>
